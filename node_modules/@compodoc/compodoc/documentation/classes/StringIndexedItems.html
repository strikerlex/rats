                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse "
                            ...
                            >
                                ...
                                <li class="link">
                                    <a href="../classes/StringIndexedItems.html"  data-type="entity-link" class="active" >StringIndexedItems</a>
                                </li>
                                <li class="link">
...
<div class="tab-content">
    <div class="tab-pane fade active in" id="info">
        ...
        <p class="comment">
            <code>test/src/todomvc-ng2/src/app/shared/miscellaneous/miscellaneous.ts</code>
        </p>
                ...
                <h3 id="inputs">Indexable</h3>
                    <table class="table table-sm table-bordered">
                        <tbody>
                            <tr>
                                <td class="col-md-4">
                                    <code>[index: string]:    <code>T</code>
            </code>
                                </td>
                            </tr>
                                    <tr>
                                        <td class="col-md-4">
                                            <div class="io-line">Defined in <a href="" data-line="18" class="link-to-prism">test/src/todomvc-ng2/src/app/shared/miscellaneous/miscellaneous.ts:18</a></div>
                                        </td>
                                    </tr>
                        </tbody>
                    </table>
    ...
    <div class="tab-pane fade tab-source-code" id="source">
        <pre class="line-numbers"><code class="language-typescript">export const PI:number &#x3D; 3.14;
