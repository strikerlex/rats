...
&nbsp;
<span class="fstat-no" title="function not covered" >  private setupMask() {</span>
<span class="cstat-no" title="statement not covered" >    if (!this.inputElement) {</span>
<span class="cstat-no" title="statement not covered" >      if (this.element.nativeElement.tagName === 'INPUT') {</span>
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Wed Jun 21 2017 22:12:19 GMT+0100 (BST)
</div>
</div>
